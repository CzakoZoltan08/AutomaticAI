# -*- coding: utf-8 -*-
"""
Created on Tue Apr 30 18:16:48 2019
...
continuous_hyper_parameter_mapping_index_key_mapping = ["alpha_1", "alpha_2", "lambda_1", "lambda_2"]
...
bounds=[(0.000001,100.99),(0.000001,100.99),(0.000001,100.99),(0.000001,100.99),(0.001,1.99),(0.001,1.99),(10.99,2999.99)]


def get_algorithm():
    return Algorithm(algorithm_type=BayesianRidge,
