# -*- coding: utf-8 -*-
"""
Created on Sat Apr 27 14:49:47 2019
...
continuous_hyper_parameter_mapping_index_key_mapping = ["min_weight_fraction_leaf"]
...
bounds=[(0.0,0.5),(1.001,199.99),(1.001,199.99),(0.001,1.99),(0.001,1.99)]


def get_algorithm():
    return Algorithm(algorithm_type=ExtraTreeClassifier,
                     algorithm_name="EXTRA TREE CLASSIFIER",
