...
continuous_hyper_parameter_mapping_index_key_mapping = ["alpha", 
                                                        ...
                                                        "eta0", 
                                                        "power_t"]
discrete_hyper_parameter_mapping = ["loss", "penalty", "learning_rate"]
...
bounds=[(0.1,10.99),(0.0,1.00),(0.001,10.99),(0.0001,10.99),(0.001,10.99),(0.001,4.99),(0.001,3.99),(0.001,2.99)]
